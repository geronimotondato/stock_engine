...
class Cuentas extends Member_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('cuenta_model', 'model');

		$this->nombre_plural   = "cuentas";
		$this->nombre_singular = "cuenta";
		$this->vista_listado   = "cuentas.php";
		$this->vista_abm       = "abm_cuenta.php";
